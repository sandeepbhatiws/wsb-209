...
export default function ViewMaterial() {
  ...
  useEffect(() => {
    axios.post(`${import.meta.env.VITE_API_URL}/materials/view`, filterData)
      .then((result) => {
  ...
  const changeStatus = () => {
    if (selectedRecord.length > 0) {
      ...
      axios.put(`${import.meta.env.VITE_API_URL}/materials/change-status`, {
        ids: selectedRecord
      })
        .then((result) => {
          if (result.data._status) {
        ...
        buttons: [
          [
            ...
            function (instance, toast) {
              ...
              axios.put(`${import.meta.env.VITE_API_URL}/materials/delete`, {
                ids: selectedRecord
              })
                .then((result) => {
                  if (result.data._status) {
